...
class VideoFotoController extends Controller
{
    ...
    function index(Request $request)
    {
        ...
        if (isset($request->cari)) {
            ...
            $data = VideoFoto::orderBy('id', 'desc')->get();
        }
    ...
    function export(Request $request)
    {
        ...
        $sql = VideoFoto::orderBy('id', 'desc')
            ->whereDate('created_at', '>=', $start_date)
            ->whereDate('created_at', '<=', $end_date)
            ->get();

        $laki_laki = VideoFoto::where('jk', 'Laki-laki')->count();
        $perempuan = VideoFoto::where('jk', 'Perempuan')->count();
        ...
        $filename = "Laporan Daftar Peserta Video Editing & Fotografi " . date($start_date) . " sampai " . date($end_date) . ".xlsx";
