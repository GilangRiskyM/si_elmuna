...
@section('content')
    ...
    <div class="col-12 col-sm-8 col-md-4">
        ...
        <form action="/sertifikat/pemrograman" method="get">
            <div class="input-group">
                ...
                <a href="/sertifikat/pemrograman" class="btn btn-danger">Batal</a>
            </div>
        </form>
    </div>
    <hr>
                ...
                @if (count($data) > 0)
                    @foreach ($data as $datum)
                        <tr>
                            ...
                            <td>
                                <a href="/sertifikat/pemrograman/edit/{{ $datum->id }}" class="btn btn-warning">Edit</a>
                                <a href="/sertifikat/pemrograman/cetak/{{ $datum->id }}/sertifikat" target="_blank"
                                    class="btn btn-success my-2">Print Sertifikat</a>
                                <a href="/sertifikat/pemrograman/cetak/{{ $datum->id }}/nilai" target="_blank"
                                    class="btn btn-success">Print Nilai</a>
                                <a href="/sertifikat/pemrograman/hapus/{{ $datum->id }}"
