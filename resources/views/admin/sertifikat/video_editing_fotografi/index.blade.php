...
@section('content')
    ...
    <div class="col-12 col-sm-8 col-md-4">
        ...
        <form action="/sertifikat/video-editing-fotografi" method="get">
            <div class="input-group">
                ...
                <a href="/sertifikat/video-editing-fotografi" class="btn btn-danger">Batal</a>
            </div>
        </form>
    </div>
    <hr>
                ...
                @if (count($data) > 0)
                    @foreach ($data as $datum)
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="/sertifikat/video-editing-fotografi/edit/{{ $datum->id }}"
                                        class="btn btn-warning">Edit</a>
                                    <a href="/sertifikat/video-editing-fotografi/cetak/{{ $datum->id }}/sertifikat"
                                        target="_blank" class="btn btn-success my-2">Print Sertifikat</a>
                                    <a href="/sertifikat/video-editing-fotografi/cetak/{{ $datum->id }}/nilai"
                                        target="_blank" class="btn btn-success">Print Nilai</a>
                                    <a href="/sertifikat/video-editing-fotografi/hapus/{{ $datum->id }}"
